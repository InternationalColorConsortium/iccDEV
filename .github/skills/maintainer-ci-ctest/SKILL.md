...
- WASM parity derives its expected ICC output set from
  `Testing/CreateAllProfiles.sh` and retained fixture profiles; do not hardcode
  generated-profile totals in WASM workflows.
