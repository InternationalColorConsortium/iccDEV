...
- [ ] Runner-reduction changes retain `container_changed` classification, the
      native matrix, blocking Dockerfile scans, and canonical publication through
      `ci-docker` on `master`; do not require a PR-specific container aggregate
