...
# so, listing "ICC/*.icc" and "Results/*.icc" as generated artifacts. Without these
# exclusions the manifest test is ordering-dependent, and the difference is not
# something a verdict baseline should adjudicate.
list_corpus() {
