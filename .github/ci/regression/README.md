...
| `.github/scripts/iccdev-applyprofiles-spectral-pcs-regression.sh` | #1671, #1675, #1677 | Spectral PCS transforms could read or write outside pixel, matrix, or illuminant buffers when processing invalid range/channel combinations | Reconstructs the three embedded PoCs, verifies fixture digests, requires #1671 to complete successfully, and requires #1675/#1677 to fail gracefully under ASAN without sanitizer findings |
