...
| **Compiler Warnings** | Should be zero on the strict tier (GCC 15+ / Clang 14+). PRs must build clean against ci-docker (GCC 15) and the ci-regression-checks ASAN+UBSAN CTest gate (current maintainer Clang). |
