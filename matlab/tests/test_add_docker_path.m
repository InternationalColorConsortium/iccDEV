...
% BSD 3-Clause License. See LICENSE.md for details.
  ...
  entries = iccdev.qa.path_entries([pathsep 'first' pathsep pathsep 'second' ...
    pathsep]);
  assert(isequal(entries, {'first', 'second'}), ...
    'Empty PATH entries must be removed before executable discovery.');
