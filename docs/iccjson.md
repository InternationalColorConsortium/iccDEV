...
```json
{
  "IccProfile": {
    ...
    "Tags": [
      ...
      {
        "mediaWhitePointTag": {
          "data": { "type": "XYZArrayType", "XYZ": [0.9505, 1.0000, 1.0891] }
        }
      },
      {
        "redMatrixColumnTag": {
          "data": { "type": "XYZArrayType", "XYZ": [0.4361, 0.2225, 0.0139] }
        }
      },
      {
        "greenMatrixColumnTag": {
          "data": { "type": "XYZArrayType", "XYZ": [0.3851, 0.7169, 0.0971] }
        }
      },
      {
        "blueMatrixColumnTag": {
          "data": { "type": "XYZArrayType", "XYZ": [0.1431, 0.0606, 0.7141] }
        }
      },
      {
        "redTRCTag": {
...
## Minimal iccMAX Profile Example
