...
| `iccProfileVisualize` | Dump profile LUT data as images and SVG graphs | `iccProfileVisualize profile.icc` |
...
| `iccSpecSepToTiff` | Combine spectral separation TIFFs | `iccSpecSepToTiff output.tif inputs.txt` |
