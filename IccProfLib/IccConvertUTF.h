...
/* ---------------------------------------------------------------------
November 2011
- Added copies of functions that place results in referenced std::vector
  thus releasing caller from responsibility of allocating buffer with
  the correct size - Max Derhak
------------------------------------------------------------------------ */
...
#include <vector>
typedef std::vector<UTF8> icUtf8Vector;
typedef std::vector<UTF16> icUtf16Vector;
typedef std::vector<UTF32> icUtf32Vector;
